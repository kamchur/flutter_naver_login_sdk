...
interface class NaverLoginSdkProtocol {
  ...
  void authenticate({OAuthLoginCallback? callback}) =>
      throw UnimplementedError('authenticate() has not been implemented');
  void refresh({OAuthLoginCallback? callback}) =>
      throw UnimplementedError('refresh() has not been implemented');
  void profile({required ProfileCallback callback}) =>
      throw UnimplementedError('profile() has not been implemented');
  void logout() =>
      throw UnimplementedError('logout() has not been implemented');
  void release({OAuthLoginCallback? callback}) =>
